...
class CyberGuardAnalyzer {
    ...
    async performFileAnalysis(file) {
        ...
        try {
            ...
            if (analysis.threatScore >= 80) analysis.threatLevel = 'critical';
            else if (analysis.threatScore >= 50) analysis.threatLevel = 'high';
            else if (analysis.threatScore >= 25) analysis.threatLevel = 'medium';
            else if (analysis.threatScore >= 10) analysis.threatLevel = 'low';
